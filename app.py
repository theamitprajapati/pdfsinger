...
dllpath = r'c:\windows\system32\SignatureP11.dll' #proxy
#dllpath = r'C:\Windows\System32\eps2003csp11v2.dll' #epass

HOST_URL = "http://app.pyaribitiya.in:8000"
...
def upload_file():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            try:
                main(filename,"Digitally Signed by:$name \n Reason: Issue form b \n Location: India \n Date: ",'12345678')
